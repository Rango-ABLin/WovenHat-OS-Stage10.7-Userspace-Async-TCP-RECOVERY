...
def main():
    ...
    parser.add_argument('--stage', choices=('10.8', '10.9', '11.1', '11.2', '11.3', '11.4', '11.5', '12.1', '12.2', '12.3', '12.4', '12.5'), default='10.8')
    ...
    required = [f'[SMP] online={args.cpus} expected={args.cpus}',
                ...
                ({'10.8': '[S10.8] completion ports + batch/cancel/timeout/teardown/SMP: PASSED',
                  ...
                  '12.5': '[S12.5] storage management: PASSED'}[args.stage])]
