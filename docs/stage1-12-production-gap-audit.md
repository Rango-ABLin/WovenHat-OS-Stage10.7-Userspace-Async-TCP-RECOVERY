...
Runtime growth now maps 256 KiB chunks outside the heap guard and publishes
each completed chunk under it; synchronous growth is restricted to rank-free,
IRQ-enabled callers, while BSP idle maintains low-water headroom for guarded
allocations. Sudden guarded demand and low-memory stress remain open.
...
physical NUMA placement remain qualification work.
