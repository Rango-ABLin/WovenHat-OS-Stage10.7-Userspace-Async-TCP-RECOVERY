...
| Stage 6 | Bounded SMP, TLB shootdowns, 1–4 CPU tests, ACPI SRAT CPU-domain discovery, domain-local placement/rebalancing, x2APIC MSR path, migratable audited I/O workers | General multicore userspace, unrestricted concurrent I/O/DMA throughput, NUMA-aware page allocation, hotplug, APIC-ID-above-255 hardware coverage |
