...
| --- | --- | --- |
| Stages 1–5 | Boot, memory, paging, scheduler, VFS, userspace, storage; 1/2/4-CPU acceptance | Non-QEMU hardware qualification/drivers, DMA storage completion, long-filename creation, crash-safe metadata ordering, per-file permissions, unclean-shutdown recovery |
