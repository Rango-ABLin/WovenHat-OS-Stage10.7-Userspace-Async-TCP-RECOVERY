...
| Stage 6 | Bounded SMP, TLB shootdowns, 1–4 CPU tests, ACPI SRAT CPU-domain discovery, domain-local placement/rebalancing | General multicore userspace and concurrent I/O, NUMA-aware page allocation, hotplug, hardware coverage |
